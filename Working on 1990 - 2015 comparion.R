...
y_internet = (poverty_1.90_per_region_na$`Poverty Headcount 1.90`)
x = (poverty_1.90_per_region_na$Year)
...
p <- plot_ly(poverty_1.90_per_region_na$`Poverty Headcount 1.90`, x = ~year) %>%
  add_trace(y = ~'Poverty Headcount 1.90', type = 'scatter', mode = 'lines', line = list(color = 'rgba(49,130,189, 1)', width = 4)) %>%
  add_trace(x = ~c(x[1], x[12]), y = ~c(poverty_1.90_per_region_na[1], ]), type = 'scatter', mode = 'markers', marker = list(color = 'rgba(49,130,189, 1)', size = 12)) %>%
