...
# Prior for beta
beta1 ~ dexp(0.072091952)    #poverty
...
var2   ~  dexp(0.072091952)    #poverty
var3   ~  dexp(0.082930)       #undernourishment
var4   ~  dexp(0.072092)       #child mortality
#var5   ~ dweib(14,74.74)      #life expactency
...
samp <- coda.samples(model, 
                     variable.names=c("beta1","beta2","beta3","sigma1","sigma2"), 
